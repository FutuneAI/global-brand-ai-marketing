...
This repository contains the framework, analysis, and reference documents behind FutuneAI's research series on AI-era marketing for global brands.

It is not a beginner's guide to AI tools. It is a structured investigation into a specific problem: **most global marketing systems were designed before AI became a layer in the buyer's decision process, and they haven't been rebuilt to account for that.**

The research covers three questions:

- How does AI change where buyers form their initial perception of a brand?
...
```
global-brand-ai-marketing/
│
├── phase-2-global-marketing/          # AI-era marketing system (5 parts)
│   ├── 01-marketing-infrastructure.md
│   ├── 02-effective-content.md
│   ├── 03-ai-search-traffic.md
│   ├── 04-b2b-decision-chain.md
│   └── 05-content-ops-rhythm.md
│
└── phase-3-case-studies/              # GEO cases and evidence (4 parts)
    ├── 01-zero-to-recommended.md
    ├── 02-entity-repair.md
    ├── 03-industry-variance.md
    └── 04-2026-review.md
```
...
This repository covers **what to do** — marketing strategy and execution in the AI era.

The underlying technical model — how AI systems form brand perception, how retrieval mechanisms work, how visibility can be assessed — is documented separately in:

**[FutuneAI/ai-visibility-framework](https://github.com/FutuneAI/ai-visibility-framework)**
...
FutuneAI researches brand visibility and growth strategy in the generative AI era, with a focus on Chinese brands expanding to international markets.

*This repository is maintained in parallel with ongoing research. Documents are updated as new observations and cases are added.*
